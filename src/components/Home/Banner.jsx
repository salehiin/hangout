...
const Banner = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row justify-center items-center md:h-screen">
      {/* Left Half */}
      <div className="md:w-1/2 pt-4 md:pt-0 px-2 md:pl-6 lg:pl-8">
      ...
      {/* Right Half */}
      <div className="flex items-center justify-center md:-mr-32 lg:-mr-20  md:-mb-60 lg:-mb-72 bg-yellow-500 w-44 p-1 rounded-2xl -skew-y-12">
