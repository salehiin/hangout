...
const CheckoutForm = ({closeModal, bookingInfo, refetch}) => {
  ...
  useEffect(()=>{
    //fetch client secret
    if(bookingInfo?.rent && bookingInfo?.rent > 1){
      getClientSecret({rent: bookingInfo?.rent})
    }
    ...
    if(paymentIntent.status === 'succeeded'){
      console.log(paymentIntent)
        ...
        try{
          ...
          //3. change flat status to booked in db
          await axiosSecure.patch(`/flat/status/${bookingInfo?._id}`, {status: true})
